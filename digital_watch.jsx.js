 ...
 * @param {!string} elm_id
 */
Application.main$S = function (elm_id) {
	/** @type {HTMLElement} */
	var elm;
	var f;
	elm = (function (o) { return o instanceof HTMLElement ? o : null; })(dom.window.document.getElementById(elm_id));
	f = (function () {
		/** @type {Date} */
		var date;
		/** @type {!string} */
